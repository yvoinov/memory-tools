...
#####################################################################################
## The script for disable extra env drop-ins for all enabled systemd services.
...
usage_note()
{
  echo "The script for disable all enabled extra env drop-ins for all enabled systemd services."
