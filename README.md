...
`enable_global_preload_linux.sh` enables non-system allocator global preload for Linux.

`disable_global_preload_linux.sh` disables non-system allocator global preload for Linux.
